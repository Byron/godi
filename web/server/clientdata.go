...
// img_file_png reads file data from disk. It returns an error on failure.
func img_file_png() ([]byte, error) {
	return bindata_read(
		"/Users/byron/Documents/dev/go-lib/src/github.com/Byron/godi/web/client/app/img/file.png",
		"img/file.png",
	)
}

// img_folder_png reads file data from disk. It returns an error on failure.
func img_folder_png() ([]byte, error) {
	return bindata_read(
		"/Users/byron/Documents/dev/go-lib/src/github.com/Byron/godi/web/client/app/img/folder.png",
		"img/folder.png",
	)
}
...
var _bindata = map[string]func() ([]byte, error){
	...
	"img/file.png": img_file_png,
	"img/folder.png": img_folder_png,
...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	...
	"img": &_bintree_t{nil, map[string]*_bintree_t{
		"file.png": &_bintree_t{img_file_png, map[string]*_bintree_t{
		}},
		"folder.png": &_bintree_t{img_folder_png, map[string]*_bintree_t{
		}},
	}},
